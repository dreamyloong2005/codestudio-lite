...
test("updater manifest maps Burn DMG and Linux artifacts", () => {
  ...
  try {
    ...
    assert.equal(manifest.platforms["darwin-aarch64"].url, "https://download.codestudio.build/releases/1.4.2/CodeStudio-Lite-1.4.2-macOS-universal.dmg");
